...
<li class="menu_line"> </li>
<li onmouseover="this.className='menu_onfocus';" onmouseout="this.className='menu_onblur';"><a href="templateSend.html">模板下发</a></li>
<li class="menu_line"> </li>
<li onmouseover="this.className='menu_onfocus';" onmouseout="this.className='menu_onblur';"><a href="checkManagement.html">考核对象管理</a></li>
<li class="menu_line"> </li>
<li class="menu_onfocus"><a href="assessStat.do?method=checkCount">考核统计</a></li>
<li class="menu_line"> </li>
</ul>
</div>
</div>
<iframe id="content" name="content" src="frame/content_frame_checkCount.html"  frameborder="0" ></iframe>
</body>
