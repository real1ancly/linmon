...
dTree.prototype.iconPath = function(path) {
	if(path!=null){
	...
	this.icon = {
			...
			root				: path+this.icon.root,

			folder			: path+this.icon.folder,

			folderOpen	: path+this.icon.folderOpen,

			node				: path+this.icon.node,

			empty				: path+this.icon.empty,

			line				: path+this.icon.line,

			join				: path+this.icon.join,

			joinBottom	: path+this.icon.joinBottom,

			plus				: path+this.icon.plus,

			plusBottom	: path+this.icon.plusBottom,

			minus				: path+this.icon.minus,

			minusBottom	: path+this.icon.minusBottom,

			nlPlus			: path+this.icon.nlPlus
